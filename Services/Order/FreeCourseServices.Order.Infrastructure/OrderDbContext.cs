...
namespace FreeCourseServices.Order.Infrastructure
{
    public class OrderDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Domain.OrderAggregate.OrderItem>().Property(k => k.Price).HasColumnType("decimal(18,2");

            modelBuilder.Entity<Domain.OrderAggregate.Order>().OwnsOne(k => k.Address).WithOwner();
